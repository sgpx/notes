...
apt install --allow-downgrades -y libapache2-mod-php libapache2-mod-php7.4 php apache2 perl
sed -i.bak -r "s/Listen 80/Listen 5000/" /etc/apache2/ports.conf
echo "ServerName 172.17.0.2" >> /etc/apache2/sites-available/000-default.conf
