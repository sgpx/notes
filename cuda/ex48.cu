/*
Compute the dot product of two vectors using shared memory reduction, without assuming the number of threads is a power of two.
*/
...
int main() {
	int N = 1024, desired_num_threads = 300;
	int num_threads = nextPow2(desired_num_threads);
