...
def load_wikipedia_link(link):
    """
    takes a wikipedia link as input and returns the HTML of its contents as output
...
def link_loader(link: str) -> str:
    """
    takes a web link as input and returns a string with its contents as output
...
def run_my_agent():
    my_tools = [
        ...
        Tool(
            name="link_loader",
            func=link_loader,
            description="takes a web link as input and returns a string with its contents as output",
        ),
    ]
    ...
    prompt_template = PromptTemplate(
        ...
        template="what is the currency of india?",
    )
    result = aexec.invoke(
